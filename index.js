...
// metodos de tipo usuarios
app.get('/tipousuarios',db.getTipousuarios)
app.get('/tipousuarios/:id',db.getTipousuariosPorId)
app.post('/tipousuarios',db.crearTipousuarios)
app.put('/tipousuarios/:id',db.actualizarTipousuarios)
app.delete('/tipousuarios/:id',db.eliminarTipousuarios)
